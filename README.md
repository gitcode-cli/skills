...
```bash
# 克隆到任意位置
git clone git@gitcode.com:gitcode-cli/gitcode-cli-skills.git /path/to/gitcode-skills

# 将每个 skill 链接到 Claude Code skills 目录
ln -s /path/to/gitcode-skills/gitcode-* ~/.claude/skills/
```
